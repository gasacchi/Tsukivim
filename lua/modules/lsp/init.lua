...
lsp.config = function()
  ...
  local servers = { 'svelte', 'denols','cssls', 'html' }
  ...
  nvim_lsp.tailwindcss.setup({
    capabilities = config.capabilities,
    on_attach = on_attach,
    filetypes = { "ejs", "html", "markdown", "mdx", "css", "less", "postcss", "sass", "scss", "stylus", "javascript", "javascriptreact", "reason", "rescript", "typescript", "typescriptreact", "vue", "svelte" },
    --[[ init_options = {
      userLanguages = {
        elm = "html"
      }
