...
cmd "autocmd FileType purescript inoremap <buffer> forall ∀<space>" -- forall
cmd "autocmd FileType purescript inoremap <buffer> :: ∷<space>" -- has type
cmd "autocmd FileType purescript inoremap <buffer> <- ←<space>" -- bind
cmd "autocmd FileType purescript inoremap <buffer> -> →<Space>" -- type
cmd "autocmd FileType purescript inoremap <buffer> => ⇒<Space>" -- constraint
cmd "autocmd FileType purescript inoremap <buffer> <= ⇐<Space>" -- impli
